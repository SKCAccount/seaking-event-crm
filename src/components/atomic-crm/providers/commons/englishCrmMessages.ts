export const englishCrmMessages = {
  resources: {
    companies: {
      ...
      empty: {
        description: "It seems your organization list is empty.",
      ...
      nb_deals: "%{smart_count} opportunity |||| %{smart_count} opportunities",
      sizes: {
      ...
      autocomplete: {
        create_error: "An error occurred while creating the organization",
        create_item: "Create %{item}",
        create_label: "Start typing to create a new organization",
      },
      filters: {
        only_mine: "Only organizations I manage",
      },
    },
    contacts: {
      ...
      filters: {
        ...
        search: "Search name, organization...",
        this_week: "This week",
        today: "Today",
        tags: "Tags",
        tasks: "Tasks",
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Welcome to Sea King Capital",
    },
    common: {
      activity: "Activity",
      added: "added",
    ...
    activity: {
      added_company: "%{name} added organization",
      you_added_company: "You added organization",
      ...
      added_note_about_deal: "%{name} added a note about opportunity",
      you_added_note_about_deal: "You added a note about opportunity",
      added_deal: "%{name} added opportunity",
      you_added_deal: "You added opportunity",
      at_company: "at",
      to: "to",
    ...
    dashboard: {
      ...
      deals_pipeline: "Opportunity Pipeline",
    ...
    import: {
      ...
      idle: {
        description_1:
          "You can import sales, organizations, contacts, opportunities, notes, and tasks.",
        description_2:
